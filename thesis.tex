...
\begin{document} 
    ...
    \titlerunning{Exploring Isotopic Ratios, Atmospheric
Composition, and the Formation Environment of PZ Tel B}

   \title{TBD}

   % \subtitle{Uncovering the depths of PZ Tel B}
...
\input{mainmatter/3-Observations}
\input{mainmatter/4-retrieval}
